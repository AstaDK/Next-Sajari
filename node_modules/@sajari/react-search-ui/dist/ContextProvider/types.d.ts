...
export declare type ResultViewType = 'grid' | 'list';
...
export interface ContextProviderValues extends SearchProviderValues, ThemeProviderProps, Omit<SearchUIContextProviderValues, 'setViewType'> {
}
